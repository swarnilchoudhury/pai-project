                                ...
                                <div className="card-body p-5 text-center">
                                    ...
                                    <form className="form" id="create-form" onSubmit={CreateHomeBtnOnClick}>
                                        ...
                                        <div className="form-group row">
                                            ...
                                            <div className="col-sm-10">
                                                <input type="text" className="form-control" id="LevelTxt" value={formsTxts.Level} onChange={(e) => setformsTxts({ ...formsTxts, Level: e.target.value })} />
                                            </div>
                                        </div>
                                        <br />
                                        <div className="form-group row">
                                            ...
                                            <div className="col-sm-10">
                                                <input type="text" className="form-control" id="StudentCodeTxt" value={formsTxts.studentCode} onChange={(e) => setformsTxts({ ...formsTxts, studentCode: e.target.value })} />
                                            </div>
                                        </div>
                                        <br />
                                        <div className="form-group row">
